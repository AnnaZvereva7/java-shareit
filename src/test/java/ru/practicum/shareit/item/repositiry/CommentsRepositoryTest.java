...
class CommentsRepositoryTest {
    ...
    void findAllCommentsByItemsId() {
        ...
        List<Comment> comments = repository.findAllCommentsByItemsId(List.of(1L));
        assertEquals(2, comments.size());
        assertEquals(1L, comments.get(0).getId());
        assertEquals(1L, comments.get(0).getItem().getId());
        assertEquals("name2", comments.get(0).getAuthor().getName());
        ...
        assertEquals(1L, comments.get(1).getItem().getId());
        assertEquals("name2", comments.get(1).getAuthor().getName());
